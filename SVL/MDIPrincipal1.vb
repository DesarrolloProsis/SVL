...
Public Class MDIPrincipal1
    ...
    Private Sub MDIPrincipal1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ObtenerRutas() '<--- Se obtienen las rutas de las plantillas de los reportes
...
#Region "Methods"
    ...
    Private Sub ObtenerRutas()

        Dim ctx As New CLRDataContext()

        Try

            Dim DictamenCR = (From a In ctx.Ruta_Reportes
                              Where a.idRuta = 1
                              Select a.Ruta.ToString() + a.Nombre_Reporte.ToString() + "." + a.Extension.ToString()).SingleOrDefault()

            Reporte_CajeroReceptor = DictamenCR.ToString()

            Dim DictamenCC = (From a In ctx.Ruta_Reportes
                              Where a.idRuta = 2
                              Select a.Ruta.ToString() + a.Nombre_Reporte.ToString() + "." + a.Extension.ToString()).SingleOrDefault()

            Reporte_CarrilesCerrados = DictamenCC.ToString()

            Dim DictamenTC = (From a In ctx.Ruta_Reportes
                              Where a.idRuta = 3
                              Select a.Ruta.ToString() + a.Nombre_Reporte.ToString() + "." + a.Extension.ToString()).SingleOrDefault()

            Reporte_TurnoCarril = DictamenTC.ToString()

            Dim DictamenDC = (From a In ctx.Ruta_Reportes
                              Where a.idRuta = 4
                              Select a.Ruta.ToString() + a.Nombre_Reporte.ToString() + "." + a.Extension.ToString()).SingleOrDefault()

            Reporte_DiaCaseta = DictamenDC.ToString()

            Dim ComparativoCR = (From a In ctx.Ruta_Reportes
                                 Where a.idRuta = 5
                                 Select a.Ruta.ToString() + a.Nombre_Reporte.ToString() + "." + a.Extension.ToString()).SingleOrDefault()

            Comparativo_CajeroReceptor = ComparativoCR.ToString()

            Dim ComparativoCC = (From a In ctx.Ruta_Reportes
                                 Where a.idRuta = 6
                                 Select a.Ruta.ToString() + a.Nombre_Reporte.ToString() + "." + a.Extension.ToString()).SingleOrDefault()

            Comparativo_CarrilesCerrados = ComparativoCC.ToString()

            Dim ComparativoTC = (From a In ctx.Ruta_Reportes
                                 Where a.idRuta = 7
                                 Select a.Ruta.ToString() + a.Nombre_Reporte.ToString() + "." + a.Extension.ToString()).SingleOrDefault()

            Comparativo_TurnoCarriles = ComparativoTC.ToString()

            Dim ComparativoDC = (From a In ctx.Ruta_Reportes
                                 Where a.idRuta = 8
                                 Select a.Ruta.ToString() + a.Nombre_Reporte.ToString() + "." + a.Extension.ToString()).SingleOrDefault()

            Comparativo_DiaCaseta = ComparativoDC.ToString()

        Catch ex As Exception
            RadMessageBox.Show(ex, "Error", MessageBoxButtons.OK, RadMessageIcon.Error)
        End Try
