    ...
    Private Sub EncabezadoGenaral()
        ...
        Select Case SeleccionReporte
            ...
            Case 4
                ...
                Dim Bolsa As New Telerik.Reporting.Parameter()
                Bolsa.Name = "Bolsa"
                Bolsa.Value = "N/A" 'ConsultarBolsa(NumDeclaracion)
                ...
                Dim HoraApertura As New Telerik.Reporting.Parameter()
                HoraApertura.Name = "HoraApertura"
                HoraApertura.Value = "06:00:00"

                'Hora de Cierre
                Dim HoraCierre As New Telerik.Reporting.Parameter()
                HoraCierre.Name = "HoraCierre"
                HoraCierre.Value = "14:00:00"
...
#Region "Reporte de Cajero-Receptor"
				...
				EfectivoMN_IM.Value = (SumarMarcado(NumDeclaracion, Efectivo)).ToString("##,##0.00")
...
#Region "Reporte de Turno/Carriles"
                ...
                EfectivoMN_IM.Value = (SumarMarcadoTurno(Efectivo)).ToString("##,##0.00")
...
#Region "Reporte de Carriles Cerrados"
                ...
                EfectivoMN_IM.Value = (0).ToString() '(SumarMarcado(NumDeclaracion, Efectivo)).ToString("##,##0.00")
                EfectivoMN_CM.Value = (0).ToString() '(ContarMarcado(NumDeclaracion, Efectivo)).ToString()
                RPI_IM.Value = (0).ToString() '(SumarMarcado(NumDeclaracion, Residente)).ToString("##,##0.00")
                RPI_CM.Value = (0).ToString() '(ContarMarcado(NumDeclaracion, Residente)).ToString()
                IAVE_IM.Value = (0).ToString() '(SumarMarcado(NumDeclaracion, IAVE)).ToString("##,##0.00")
                IAVE_CM.Value = (0).ToString() '(ContarMarcado(NumDeclaracion, IAVE)).ToString()
                TDC_IM.Value = (0).ToString() '(SumarMarcado(NumDeclaracion, TDC)).ToString("##,##0.00")
                TDC_CM.Value = (0).ToString() '(ContarMarcado(NumDeclaracion, TDC)).ToString()
                TDD_IM.Value = (0).ToString() '(SumarMarcado(NumDeclaracion, TDD)).ToString("##,##0.00")
                TDD_CM.Value = (0).ToString() '(ContarMarcado(NumDeclaracion, TDD)).ToString()
                VSC_IM.Value = (0).ToString() '(SumarMarcado(NumDeclaracion, VSC)).ToString("##,##0.00")
                VSC_CM.Value = (0).ToString() '(ContarMarcado(NumDeclaracion, VSC)).ToString()
                RSP_IM.Value = (0).ToString() '(SumarMarcado(NumDeclaracion, RSP)).ToString("##,##0.00")
                RSP_CM.Value = (0).ToString() '(ContarMarcado(NumDeclaracion, RSP)).ToString()
                Eludido_IM.Value = (0).ToString() '(SumarMarcado(NumDeclaracion, Violacion)).ToString("##,##0.00")
                Eludido_CM.Value = (0).ToString() '(ContarMarcado(NumDeclaracion, Violacion)).ToString()
                Reclasificados_IM.Value = (0).ToString() '(SumarSecuencias(NumDeclaracion, Reclasificados)).ToString("##,##0.00")
                Reclasificados_CM.Value = (0).ToString() '(ContarSecuencias(NumDeclaracion, Reclasificados)).ToString()
                Discrepancias_IM.Value = (0).ToString() '(SumarPaso(NumDeclaracion, Discrepancias)).ToString("##,##0.00")
                Discrepancias_CM.Value = (0).ToString() '(ContarPaso(NumDeclaracion, Discrepancias)).ToString()
                Boletos_CM.Value = (0).ToString() '(ContarBoletos(NumDeclaracion)).ToString()
...
#Region "Reporte de Carriles Cerrados"
                ...
                EfectivoMN_IV.Value = (0).ToString() '(SumarVerificado(NumDeclaracion, Efectivo)).ToString("##,##0.00")
                EfectivoMN_CV.Value = (0).ToString() '(ContarVerificado(NumDeclaracion, Efectivo)).ToString()
                RPI_IV.Value = (0).ToString() '(SumarVerificado(NumDeclaracion, Residente)).ToString("##,##0.00")
                RPI_CV.Value = (0).ToString() '(ContarVerificado(NumDeclaracion, Residente)).ToString()
                IAVE_IV.Value = (0).ToString() '(SumarVerificado(NumDeclaracion, IAVE)).ToString("##,##0.00")
                IAVE_CV.Value = (0).ToString() '(ContarVerificado(NumDeclaracion, IAVE)).ToString()
                TDC_IV.Value = (0).ToString() '(SumarVerificado(NumDeclaracion, TDC)).ToString("##,##0.00")
                TDC_CV.Value = (0).ToString() '(ContarVerificado(NumDeclaracion, TDC)).ToString()
                TDD_IV.Value = (0).ToString() '(SumarVerificado(NumDeclaracion, TDD)).ToString("##,##0.00")
                TDD_CV.Value = (0).ToString() '(ContarVerificado(NumDeclaracion, TDD)).ToString()
                VSC_IV.Value = (0).ToString() '(SumarVerificado(NumDeclaracion, VSC)).ToString("##,##0.00")
                VSC_CV.Value = (0).ToString() '(ContarVerificado(NumDeclaracion, VSC)).ToString()
                RSP_IV.Value = (0).ToString() '(SumarVerificado(NumDeclaracion, RSP)).ToString("##,##0.00")
                RSP_CV.Value = (0).ToString() '(ContarVerificado(NumDeclaracion, RSP)).ToString()
                Eludido_IV.Value = (0).ToString() '(SumarVerificado(NumDeclaracion, Violacion)).ToString("##,##0.00")
                Eludido_CV.Value = (0).ToString() '(ContarVerificado(NumDeclaracion, Violacion)).ToString()
                Discrepancias_IV.Value = (0).ToString() '(SumarPaso(NumDeclaracion, Discrepancias)).ToString("##,##0.00")
                Discrepancias_CV.Value = (0).ToString() '(ContarPaso(NumDeclaracion, Discrepancias)).ToString()
...
#Region "Efectivo"
                ...
                A01_E.Value = (0).ToString() '(ContarNormales(NumDeclaracion, Efectivo)).ToString()
                M01_E.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T01M, Efectivo)).ToString()
                B02_E.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T02B, Efectivo)).ToString()
                B03_E.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T03B, Efectivo)).ToString()
                B04_E.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T04B, Efectivo)).ToString()
                C02_E.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T02C, Efectivo)).ToString()
                C03_E.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T03C, Efectivo)).ToString()
                C04_E.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T04C, Efectivo)).ToString()
                C05_E.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T05C, Efectivo)).ToString()
                C06_E.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T06C, Efectivo)).ToString()
                C07_E.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T07C, Efectivo)).ToString()
                C08_E.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T08C, Efectivo)).ToString()
                C09_E.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T09C, Efectivo)).ToString()
                EE1_E.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, TL01A, Efectivo) + (ContarVehiculos(NumDeclaracion, TL02A, Efectivo) * 2) + SumarEjes(NumDeclaracion, T01LnnA, Efectivo)).ToString()
                EE2_E.Value = (0).ToString() '(SumarEjes(NumDeclaracion, T09PnnC, Efectivo)).ToString()
...
#Region "RPI"
                ...
                A01_RPI.Value = (0).ToString() '(ContarNormales(NumDeclaracion, Residente)).ToString()
                M01_RPI.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T01M, Residente)).ToString()
                B02_RPI.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T02B, Residente)).ToString()
                B03_RPI.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T03B, Residente)).ToString()
                B04_RPI.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T04B, Residente)).ToString()
                C02_RPI.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T02C, Residente)).ToString()
                C03_RPI.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T03C, Residente)).ToString()
                C04_RPI.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T04C, Residente)).ToString()
                C05_RPI.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T05C, Residente)).ToString()
                C06_RPI.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T06C, Residente)).ToString()
                C07_RPI.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T07C, Residente)).ToString()
                C08_RPI.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T08C, Residente)).ToString()
                C09_RPI.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T09C, Residente)).ToString()
                EE1_RPI.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, TL01A, Residente) + (ContarVehiculos(NumDeclaracion, TL02A, Residente) * 2) + SumarEjes(NumDeclaracion, T01LnnA, Residente)).ToString()
                EE2_RPI.Value = (0).ToString() '(SumarEjes(NumDeclaracion, T09PnnC, Residente)).ToString()
...
#Region "IAVE"
                ...
                A01_IAVE.Value = (0).ToString() '(ContarNormales(NumDeclaracion, IAVE)).ToString()
                M01_IAVE.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T01M, IAVE)).ToString()
                B02_IAVE.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T02B, IAVE)).ToString()
                B03_IAVE.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T03B, IAVE)).ToString()
                B04_IAVE.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T04B, IAVE)).ToString()
                C02_IAVE.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T02C, IAVE)).ToString()
                C03_IAVE.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T03C, IAVE)).ToString()
                C04_IAVE.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T04C, IAVE)).ToString()
                C05_IAVE.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T05C, IAVE)).ToString()
                C06_IAVE.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T06C, IAVE)).ToString()
                C07_IAVE.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T07C, IAVE)).ToString()
                C08_IAVE.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T08C, IAVE)).ToString()
                C09_IAVE.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T09C, IAVE)).ToString()
                EE1_IAVE.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, TL01A, IAVE) + (ContarVehiculos(NumDeclaracion, TL02A, IAVE) * 2) + SumarEjes(NumDeclaracion, T01LnnA, IAVE)).ToString()
                EE2_IAVE.Value = (0).ToString() '(SumarEjes(NumDeclaracion, T09PnnC, IAVE)).ToString()
...
#Region "Tarjeta de Credito"
                ...
                A01_TDC.Value = (0).ToString() '(ContarNormales(NumDeclaracion, TDC)).ToString()
                M01_TDC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T01M, TDC)).ToString()
                B02_TDC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T02B, TDC)).ToString()
                B03_TDC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T03B, TDC)).ToString()
                B04_TDC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T04B, TDC)).ToString()
                C02_TDC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T02C, TDC)).ToString()
                C03_TDC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T03C, TDC)).ToString()
                C04_TDC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T04C, TDC)).ToString()
                C05_TDC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T05C, TDC)).ToString()
                C06_TDC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T06C, TDC)).ToString()
                C07_TDC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T07C, TDC)).ToString()
                C08_TDC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T08C, TDC)).ToString()
                C09_TDC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T09C, TDC)).ToString()
                EE1_TDC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, TL01A, TDC) + (ContarVehiculos(NumDeclaracion, TL02A, TDC) * 2) + SumarEjes(NumDeclaracion, T01LnnA, TDC)).ToString()
                EE2_TDC.Value = (0).ToString() '(SumarEjes(NumDeclaracion, T09PnnC, TDC)).ToString()
...
#Region "Tarjeta de Debito"
                ...
                A01_TDD.Value = (0).ToString() '(ContarNormales(NumDeclaracion, TDD)).ToString()
                M01_TDD.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T01M, TDD)).ToString()
                B02_TDD.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T02B, TDD)).ToString()
                B03_TDD.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T03B, TDD)).ToString()
                B04_TDD.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T04B, TDD)).ToString()
                C02_TDD.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T02C, TDD)).ToString()
                C03_TDD.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T03C, TDD)).ToString()
                C04_TDD.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T04C, TDD)).ToString()
                C05_TDD.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T05C, TDD)).ToString()
                C06_TDD.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T06C, TDD)).ToString()
                C07_TDD.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T07C, TDD)).ToString()
                C08_TDD.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T08C, TDD)).ToString()
                C09_TDD.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T09C, TDD)).ToString()
                EE1_TDD.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, TL01A, TDD) + (ContarVehiculos(NumDeclaracion, TL02A, TDD) * 2) + SumarEjes(NumDeclaracion, T01LnnA, TDD)).ToString()
                EE2_TDD.Value = (0).ToString() '(SumarEjes(NumDeclaracion, T09PnnC, TDD)).ToString()
...
#Region "VSC"
                ...
                A01_VSC.Value = (0).ToString() '(ContarNormales(NumDeclaracion, VSC)).ToString()
                M01_VSC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T01M, VSC)).ToString()
                B02_VSC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T02B, VSC)).ToString()
                B03_VSC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T03B, VSC)).ToString()
                B04_VSC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T04B, VSC)).ToString()
                C02_VSC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T02C, VSC)).ToString()
                C03_VSC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T03C, VSC)).ToString()
                C04_VSC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T04C, VSC)).ToString()
                C05_VSC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T05C, VSC)).ToString()
                C06_VSC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T06C, VSC)).ToString()
                C07_VSC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T07C, VSC)).ToString()
                C08_VSC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T08C, VSC)).ToString()
                C09_VSC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T09C, VSC)).ToString()
                EE1_VSC.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, TL01A, VSC) + (ContarVehiculos(NumDeclaracion, TL02A, VSC) * 2) + SumarEjes(NumDeclaracion, T01LnnA, VSC)).ToString()
                EE2_VSC.Value = (0).ToString() '(SumarEjes(NumDeclaracion, T09PnnC, VSC)).ToString()
...
#Region "Eludidos"
                ...
                A01_Eludidos.Value = (0).ToString() '(ContarNormales(NumDeclaracion, Violacion)).ToString()
                M01_Eludidos.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T01M, Violacion)).ToString()
                B02_Eludidos.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T02B, Violacion)).ToString()
                B03_Eludidos.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T03B, Violacion)).ToString()
                B04_Eludidos.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T04B, Violacion)).ToString()
                C02_Eludidos.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T02C, Violacion)).ToString()
                C03_Eludidos.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T03C, Violacion)).ToString()
                C04_Eludidos.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T04C, Violacion)).ToString()
                C05_Eludidos.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T05C, Violacion)).ToString()
                C06_Eludidos.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T06C, Violacion)).ToString()
                C07_Eludidos.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T07C, Violacion)).ToString()
                C08_Eludidos.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T08C, Violacion)).ToString()
                C09_Eludidos.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, T09C, Violacion)).ToString()
                EE1_Eludidos.Value = (0).ToString() '(ContarVehiculos(NumDeclaracion, TL01A, Violacion) + (ContarVehiculos(NumDeclaracion, TL02A, Violacion) * 2) + SumarEjes(NumDeclaracion, T01LnnA, Violacion)).ToString()
                EE2_Eludidos.Value = (0).ToString() '(SumarEjes(NumDeclaracion, T09PnnC, Violacion)).ToString()
...
#Region "Functions"
    ...
    Private Function ConsultarPlaza(idCaseta As Integer) As String
		...
		Return idPlazaR.ToString() + " - " + nombre.ToString()
